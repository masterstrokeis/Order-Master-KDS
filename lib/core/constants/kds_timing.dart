abstract final class KdsTiming {
  ...
  static const Duration keypadBufferTimeout = Duration(milliseconds: 2500);
  static const Duration keypadFlashDuration = Duration(milliseconds: 1500);
  static const Duration keypadLegendIdleTimeout = Duration(seconds: 30);
